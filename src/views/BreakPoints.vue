  ...
  <v-container>
    <v-card>
      ...
      <v-container class="grey lighten-3">
        <v-card class="pa-3" :height="height" outlined>
          contents
        </v-card>
      </v-container>
    </v-card>
    ...
    <v-card class="mt-5">
      <v-card-title>
        $vuetify.breakpointasdsadadsa.mobile: {{ $vuetify.breakpoint.mobile }} {{ $vuetify.breakpoint.mobileBreakpoint }}
      </v-card-title>
      <v-container class="grey lighten-3">
        <v-dialog v-model="dialog" width="500" :fullscreen="$vuetify.breakpoint.mobile">
          ...
          <v-card>
            <v-card-title class="test-h5 grey lighten-2">
              Privacy Policy
            </v-card-title>
